    ...
    return (
        <div className='flex justify-center '>
            <div className='w-[70%] h-[2rem] flex justify-end'>
                <button 
                    className='bg-purple-800 text-white p-1 w-[5rem] rounded-lg mx-2 md:hover:bg-purple-500 disabled:opacity-50 md:hover:cursor-pointer disabled:cursor-not-allowed text-2xl flex justify-center' 
